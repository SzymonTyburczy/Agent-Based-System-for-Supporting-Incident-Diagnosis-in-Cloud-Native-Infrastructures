...
nohup kubectl port-forward svc/prom-stack-grafana 8081:80 -n observability >/dev/null 2>&1 &
nohup kubectl port-forward svc/prom-stack-kube-prometheus-prometheus 9090:9090 -n observability >/dev/null 2>&1 &
nohup kubectl port-forward svc/prom-stack-kube-prometheus-alertmanager 9093:9093 -n observability >/dev/null 2>&1 &
nohup kubectl port-forward svc/grafana-mcp 8000:8000 -n observability >/dev/null 2>&1 &
